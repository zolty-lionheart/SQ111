 ...
 * @date 2020-03-17
 */
public interface TestSelectedMapper 
{
    /**
     * 查询选中集
     * 
     ...
     * @return 选中集集合
     */
    public List<TestSelected> selectTestSelectedList(TestSelected testSelected,@Param("loginName") String loginName);
     ...
     * 描述：保存方案
     */
    public List<TestSelected> selectTestSelectedListAll(@Param("loginName") String loginName);
}
